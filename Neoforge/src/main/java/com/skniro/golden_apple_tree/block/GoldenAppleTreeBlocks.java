...
public class GoldenAppleTreeBlocks {
    ...
    public static final Supplier<Block> Golden_APPLE_LEAVES =registerBlock("golden_apple_leave",
            (settings)-> new LeafCropBlock(settings, Items.GOLDEN_APPLE), BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).strength(0.2F).sound(SoundType.GRASS).noOcclusion().isSuffocating(GoldenAppleTreeBlocks::never).noOcclusion().isValidSpawn(Blocks::ocelotOrParrot).ignitedByLava().pushReaction(PushReaction.POPPED).isRedstoneConductor(GoldenAppleTreeBlocks::never));
    ...
    public static final Supplier<Block> APPLE_LEAVES =registerBlock("apple_leave",
            (settings)-> new LeafCropBlock(settings, Items.APPLE), BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).strength(0.2F).sound(SoundType.GRASS).noOcclusion().isSuffocating(GoldenAppleTreeBlocks::never).noOcclusion().isValidSpawn(Blocks::ocelotOrParrot).ignitedByLava().pushReaction(PushReaction.POPPED).isRedstoneConductor(GoldenAppleTreeBlocks::never));
