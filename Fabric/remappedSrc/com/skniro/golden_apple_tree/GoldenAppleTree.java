...
public class GoldenAppleTree implements ModInitializer {
    ...
    public static final ResourceKey<CreativeModeTab> Golden_Apple_Group = ResourceKey.create(Registries.CREATIVE_MODE_TAB, ResourceLocation.fromNamespaceAndPath(MOD_ID, "golden_apple_tree_group"));
