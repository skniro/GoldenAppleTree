    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> featureRegisterable) {
        ...
        register(featureRegisterable, Golden_APPLE_TREE, Feature.TREE,
                new TreeConfiguration.TreeConfigurationBuilder(
                        ...
                        new WeightedStateProvider(pool().add(GoldenAppleTreeBlocks.Apple_Tree_LEAVES.defaultBlockState(), 3).add(GoldenAppleTreeBlocks.Golden_APPLE_LEAVES.defaultBlockState(), 1)),
